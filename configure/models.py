...
class CPU(models.Model):
    ...
    benchmark_mark = models.FloatField(null=True, default=-1)
    thread_mark = models.FloatField(null=True, default=-1)
...
class GPU(models.Model):
    ...
    price = models.IntegerField()
    picture = models.URLField(null=True)
    g3d_mark = models.FloatField(null=True, default=0)
    g2s_mark = models.FloatField(null=True, default=0)
    guarantee = models.CharField(max_length=30, null=True)
